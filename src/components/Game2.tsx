...
export default function Game2({ onSuccess, onFail }: Game2Props) {
  ...
  useEffect(() => {
    const initialImages = [
      { id: 1, src: `${import.meta.env.BASE_URL}assets/game2/fake1.JPG`, isReal: false },
      { id: 2, src: `${import.meta.env.BASE_URL}assets/game2/real.jpeg`, isReal: true },
      { id: 3, src: `${import.meta.env.BASE_URL}assets/game2/fake2.PNG`, isReal: false },
      { id: 4, src: `${import.meta.env.BASE_URL}assets/game2/fake3.jpg`, isReal: false },
    ];
    // Shuffle
    ...
    >
      ...
      <div className="mb-8">
        ...
        <div className="flex justify-center mb-4">
          <img 
            src={`${import.meta.env.BASE_URL}assets/game2/masterpiece1.jpeg`}
